...
class Skills_Decs(models.Model):
    ...
    desc = models.TextField()
    level1 = models.CharField(max_length=100, null=True)
    need1_1 = models.CharField(max_length=20, null=True)
    need1_2 = models.CharField(max_length=20, null=True)
    level2 = models.CharField(max_length=100, null=True)
    need2_1 = models.CharField(max_length=20, null=True)
    need2_2 = models.CharField(max_length=20, null=True)
    level3 = models.CharField(max_length=100, null=True)
    need3_1 = models.CharField(max_length=20, null=True)
    need3_2 = models.CharField(max_length=20, null=True)
    level4 = models.CharField(max_length=100, null=True)
    need4_1 = models.CharField(max_length=20, null=True)
    need4_2 = models.CharField(max_length=20, null=True)
