...
urlpatterns = [
    ...
    path('character_detail/<int:char_id>/calculate_hit', views.calculateGettingHit.as_view(), name='calculate_getting_hit'),
    ...
    path('items/give<str:item_id>;<int:from_char>;<int:to_char>;<str:amount>', views.give_item, name='give_item'),
